...
```{r}
wacities <- data.frame(state = rep("Washington", 4), city = c(
    "Portland", "Olympia", "Seattle", "Vacouver"), lat = c(45.523064, 
    47.037872, 47.608013, 49.246292), lng = c(-122.676483, 
...
design <- "
  ...
  11#
"
mp+WAstate+ plot_layout(design = design)

#(p1 | (p2 / p3)) +

ggsave("figs/meadow_sites_revamp.png",dpi=200, dev='png',  height=6, width=6,units="in")
